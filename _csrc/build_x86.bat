...
set INSTALL_DIR=%CD%\..\libs\windows_386

echo === Setting up VS 2015 x86 environment ===
call "%VCVARS%" x86
if %ERRORLEVEL% neq 0 (
    echo Failed to set up VS 2015 x86 environment
    exit /b 1
)
...
copy /Y "%BUILD_DIR%\Release\golibjpeg.dll" "%EMBED_DIR%\golibjpeg_386.dll"
